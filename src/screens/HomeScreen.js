...
export function HomeScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      {/* header */}
     <View style={{width: "100%",paddingTop:25,elevation:8,backgroundColor: 'white',alignItems:'center',flexDirection:"row"}}>
              <Image source={require("../../assets/sena.png")} style={{width:90,height: 90,}}></Image>
                  <TextInput placeholder="Search News" textAlign="center"  style={styles.search}></TextInput>
     </View>
      {/* header */}
...
{/* Breaking news */}
      ...
      <FlatList
        ...
        ListHeaderComponent={ <BreakingNews></BreakingNews>}
        renderItem={({ item }) => (
          <ProductCard
      ...
      //  contentContainerStyle={{paddingVertical: 20,paddingHorizontal: 20,gap:10}}
      ></FlatList>
{/* <Button title="clear jwt"
 onPress={()=>{authService.logout()
   ,navigation.replace("AuthStack")
   ,console.log("cleared");
}}></Button> */}
{/* <BreakingBadge></BreakingBadge> */}
    </SafeAreaView>
  );
}
